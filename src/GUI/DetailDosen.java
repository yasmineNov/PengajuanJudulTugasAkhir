 ...
 * @author yasmine
 */
public class DetailDosen extends javax.swing.JFrame {

    /**
     * Creates new form DetailDosen
     */
    public DetailDosen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        pengajuan.add(judulnama, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 400, -1));
        ...
        jLabeltopjudul.setText("Detail Tugas Akhir Mahasiswa ");
        pengajuan.add(jLabeltopjudul, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, -1, -1));
        ...
        pengajuan.add(jLabeljudul, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailDosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailDosen().setVisible(true);
            }
        });
    }
